...
/**
 * Interface for Get command class
 */
public interface IGet {

  String getURLArgument(String urlArgument);

  void saveURLToFile(String urlContent, String urlFileName,
      IDirectory currentDir);

  String getURLFileName(String argument);

  boolean checkValidURLFileName(String urlFileName);

  IDirectory executeCommand(String[] arguments, int numArgs,
