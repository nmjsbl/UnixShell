 ...
 */
public class MockFile implements DirectoryTreeNode, IFile {
  /**
   ...
   * @param documents is the parent directory to add the file to
   */
  public MockFile(String name, IDirectory documents) {
    this.fileName = name;
    this.parentDirectory = documents;
  }
   ...
   * 
   * @param the new parent directory of this file
   */

  @Override
  public void changeParent(IDirectory parent) {
